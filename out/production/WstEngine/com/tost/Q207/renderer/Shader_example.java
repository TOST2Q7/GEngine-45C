package com.tost.Q207.renderer;
...
public class Shader_example {
    public int programId;
    public short frag_file;
    public short vert_file;

    public void create(float[] color) {


    }

    public Shader_example(String vsSrc, String fsSrc) {
...
//            BufferedReader reader = new BufferedReader(new InputStreamReader(in));
            ...
            System.err.println("This file '" + file + "' cound be read!");
            e.printStackTrace();
